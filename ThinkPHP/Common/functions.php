...
function session($name,$value='') {
    ...
    if(is_array($name)) { // session初始化 在session_start 之前调用
        ...
        if(isset($name['use_only_cookies']))  ini_set('session.use_only_cookies', $name['use_only_cookies']?1:0);
...
function ability_arrs(){
    //社会视野、人际交往、团队合作、自我管理、创新思维、人文修养、组织策划、身心健康
    $arr = array(
        0=>array('id'=>1,'name'=>'社会视野'),
        1=>array('id'=>2,'name'=>'人际交往'),
        2=>array('id'=>3,'name'=>'团队合作'),
        3=>array('id'=>4,'name'=>'自我管理'),
        4=>array('id'=>5,'name'=>'创新思维'),
        5=>array('id'=>6,'name'=>'人文修养'),
        6=>array('id'=>7,'name'=>'组织策划'),
        7=>array('id'=>8,'name'=>'身心健康')
    );
    return $arr;
}
