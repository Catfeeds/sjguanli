...
require_once dirname(__DIR__) . '/../../ThinkPHP/Extend/Vendor/AliyunSms/vendor/autoload.php';
...
class AliyunSmsService extends Model
{
    private $accessKeyId = '';
    ...
    {
        $this->accessKeyId = C('aliyun_accessKeyId');
        $this->accessKeySecret = C('aliyun_accessKeySecret');
