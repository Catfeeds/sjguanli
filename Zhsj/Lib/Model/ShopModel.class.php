...
class ShopModel extends CommonModel{
	...
	public function get_tj($city_id){
		$shop = $this->where('is_ding = 1 and audit=1 and closed=0 and city_id=  '.$city_id)->order(array('orderby'=>'asc','score'=>'desc','view'=>'desc'))->limit(0,8)->select();
