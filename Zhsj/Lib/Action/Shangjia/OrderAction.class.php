...
//        $this->check_weidian();
        ...
        $arrs = D('Goods')->where(array('shop_id'=>$this->shop_id,'is_delete'=>0))->field('goods_id,title')->order('create_time desc')->select();
        ...
        if($_GET['nickname']){
            $where['u.nickname'] = array('like','%'.trim($_GET['nickname']).'%');
            $this->assign('nickname',trim($_GET['nickname']));
        }
        $count = $Order->alias(o)
        ...
        $list = $Order->alias(o)
            ...
            ->field('o.order_id,o.created_at,g.title,u.nickname,u.mobile,o.total_price,o.status,g.goods_id')
    ...
    public function detail(){
        ...
        $info = D('Order')->alias('o')
            ...
            ->field('o.`status`,u.nickname,u.mobile,o.created_at,g.title,g.photo,g.start_time,g.finaly_time,o.original_price,o.total_price,o.pay_time,o.remark,
