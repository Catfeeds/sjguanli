...
<form class="main" method="post" target="baocms_frm" action="<?php echo U('goods/editsave');?>">
    ...
    <div class="price">
        ...
        <div style="float:left">
            <input type="text" name="mall_price" placeholder="0.00" value="<?php echo ($info["mall_price"]); ?>"/>
            <span>元</span>
        </div>
        <div class="left">
            <i>*</i>
        ...
        <div style="float:left">
            <input type="text" name="price" id="price" placeholder="0.00" value="<?php echo ($info["price"]); ?>"/>
            <span>元</span>
        </div>
        <div class="left">
            <i>*</i>
        ...
        <div style="float:left">
            <input type="text" name="settlement_price" placeholder="0.00" value="<?php echo ($info["settlement_price"]); ?>"/>
            <span>元</span>
        </div>
        <div class="tip" style="float:left">
    ...
    <div class="num">
        ...
        <div style="float:left">
            <input type="text" name="max_num" placeholder="0" value="<?php echo ($info["max_num"]); ?>"/>
            <span>人</span>
        </div>
        <div class="left">
            <span>最低可报名人数：</span>
        ...
        <div style="float:left">
            <input type="text" name="min_num" placeholder="0" value="<?php echo ($info["min_num"]); ?>"/>
            <span>人</span>
        </div>
        <div class="left penum">
            <b <?php if(($info[max_num] == 0) AND ($info[min_num] == 0)): ?>class="active"<?php endif; ?>></b>
            <input type="checkbox" name="nolimit" value="1" <?php if(($info[max_num] == 0) AND ($info[min_num] == 0)): ?>checked="checked"<?php endif; ?>/>
            <label>不限定报名人数</label>
        </div>
        <div class="tip" style="float:left">
    ...
    <div class="notice">
        <div style="overflow:hidden">
            ...
            <div style="float:left">
                <input type="text" class="radius3 tuan_topser" name="start_time" value="<?php echo (date('Y-m-d H:i:s',$info["start_time"])); ?>" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});"
                />
            </div>
            <div class="left">
                <i>*</i>
            ...
            <div style="float:left">
                <input type="text" class="radius3 tuan_topser" name="end_time" value="<?php echo (date('Y-m-d H:i:s',$info["end_time"])); ?>" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});"
                />
            </div>
            <div class="left">
                <span>报名截止时间：</span>
            ...
            <div style="float:left">
                <input type="text" class="radius3 tuan_topser" name="finaly_time" value="<?php echo (date('Y-m-d H:i:s',$info["finaly_time"])); ?>" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});">
            </div>
        </div>
    </div>
    <div style="overflow:hidden">
    ...
    <div class="refund">
        ...
        <div style="float:left">
            ...
            <label <?php if($info["refund_type"] == 3): ?>class="active"<?php endif; ?>>
                <i></i>
                <input type="radio" name="refund_type" value="3" <?php if($info["refund_type"] == 3): ?>checked="checked"<?php endif; ?>/>报名截止日前可退</label>
        </div>
    </div>
    <script>
        $(function () {
    ...
    <div class="address">
        ...
        <input type="text" name="address" id="address" value="<?php echo ($info["address"]); ?>" placeholder="请填写详细地址"/>
        <br>
        <input class="lat" type="text" name="latandlng" placeholder="点击按钮获取地址经纬度" value="<?php echo ($latandlng); ?>"/>
