...
<div class="contain">
    <div class="activity_info">
        ...
        <p class="order_info">
            <span>当前报名人数：<span class="order_num">99</span>个</span><span style="margin-left: 25px">最低成团人数：<span class="order_num">12,672.00</span>人</span>
        </p>
    ...
    <table class="tuan_table" border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        <script>
            ...
            <tr>
                ...
                <!-- <td>
                    <a href="<?php echo U('order/detail',array('order_id'=>$var['order_id']));?>">查看详情</a>
                </td> -->
            </tr>
            <tr>
                <!--<td>-->
