    ...
    <script>
        ...
        $(function () {
            $('.loginintw').on('focus',function (e) {
                e.target.style.border="1px solid #00bc71"
              })
    ...
    <style>
        * {
        ...
        .login_nr_l{
            ...
            left: 0;
            bottom: 0;
            background: url('__TMPL__statics/images/loginimg_04.png') center/cover no-repeat;
        }
        .login_nr_r{
            position: absolute;
            right: 0;
...
<body>
    ...
    <div class="login_top w">
        <div class="login_topnr">
            <div class="left login_topt">商家管理中心</div>
            <div class="right">
                <ul>
    ...
    <div class="bg">
        <div class="login_nr w">
            <div class="left login_nr_l">
                <!-- <img src="__TMPL__statics/images/loginimg_04.png" /> -->
            </div>
