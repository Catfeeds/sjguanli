<?php if (!defined('THINK_PATH')) exit();?><script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=7b92b3afff29988b6d4dbf9a00698ed8"></script>
...
// 百度地图API功能
    ...
    function showInfo(e) {
        // parent.selectCallBack('address',document.getElementById('lng').value +";"+ document.getElementById('lat').value);
    }
