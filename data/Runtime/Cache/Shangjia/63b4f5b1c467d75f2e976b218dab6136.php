...
<!-- <form class="main"> -->
    ...
    <div>
        ...
        <select class="select" name="com_type" id="">
            <option value="0" style="display:none" selected>请选择活动分类</option>
    ...
    <div class="price">
        ...
        <div style="float:left">
            <input type="text" placeholder="0.00" name="mall_price" value=""/>
            <span>元</span>
        </div>
        <div class="left">
            <i>*</i>
        ...
        <div style="float:left">
            <input type="text" placeholder="0.00" name="price" value=""/>
            <span>元</span>
        </div>
        <div class="left">
            <i>*</i>
        ...
        <div style="float:left">
            <input type="text" placeholder="0.00" name="settlement_price" value=""/>
            <span>元</span>
        </div>
        <div class="tip" style="float:left">
    ...
    <div class="notice">
        <div style="overflow:hidden">
            ...
            <div style="float:left">
                <input type="text" name="start_time" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});" value=""/>
            </div>
            <div class="left">
                <i>*</i>
                <span>结束时间：</span>
            ...
            <div style="float:left">
                <input type="text" name="end_time" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});" value=""/>
            </div>
            <div class="left">
                <span>报名截止时间：</span>
            </div>
            <div style="float:left">
                <input type="text" name="finaly_time" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'});" value=""/>
            </div>
        </div>
    </div>
    <div style="overflow:hidden">
    ...
    <div class="refund">
        ...
        <div style="float:left">
            <label>
                <i></i>
                <input name="refund_type" type="radio" value="1">可以退款</label>
            <label>
                <i></i>
                <input name="refund_type" type="radio" value="2">不可退款</label>
        </div>
    </div>
    <script>
        $(function () {
    ...
    <div class="address">
        ...
        <input type="text" placeholder="请填写详细地址" name="address" value=""/>
        <br>
        <input class="lat" type="text" name="latandlng" value="" placeholder="点击按钮获取地址经纬度"/>
        <!--<iframe id="iframe" src="<?php echo U('public/maps');?>" name="bb" frameborder="0" width="600px" height="500px" onload="load()"></iframe>-->
        <iframe id="iframe" src="<?php echo U('public/maps');?>" name="bb" frameborder="0" width="600px" height="600px" onload="load()"></iframe>
