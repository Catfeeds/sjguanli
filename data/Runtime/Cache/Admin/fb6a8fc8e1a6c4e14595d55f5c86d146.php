...
<head>
    ...
    <!-- <link href="../statics/css/pub.css" rel="stylesheet" type="text/css" /> -->
...
<div class="main_logon">
    ...
    <div class="login">
        <div class="title"><?php echo ($CONFIG["site"]["title"]); ?>后台管理系统</div>
            ...
            <table cellpssssadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td><input type="text" name="yzm" class="yzm" placeholder="请输入验证码" />
                        <span class="yzm_code" style="margin:2px 0 0px; display:block; cursor:pointer;"><img style="width:100px; height:38px;"  src="<?php echo U('App/Verify/index',array('mt'=>time())) ;?>" /></span></td>
                </tr>
                <tr>
