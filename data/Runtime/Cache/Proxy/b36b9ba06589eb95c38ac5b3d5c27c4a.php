...
<style>
    ...
    .sjgl_top{
        height: 72px;
        line-height: 72px;
        background-image: linear-gradient(-90deg, rgba(9,113,242,0.99) 0%, rgba(28,153,250,0.99) 100%);
    }
    .modify{
        padding: 0;
        line-height: 72px;
    ...
    /* sjgl_leftmenu end */
    .sjgl_top_r .sjgl_toplixl .message{
        position: relative;
        margin-left: 48px;
        ...
        height: 15px;
        vertical-align: middle;
        background: url('__TMPL__statics/images/icon_message16x16.png') no-repeat center;
    }
    .sjgl_top_r .sjgl_toplixl .message i{
        position: absolute;
        top: -5px;
        right: -5px;
        width: 8px;
...
<div class="sjgl_top">
    ...
    <div class="right sjgl_top_r">
        <ul>
            <li class="left sjgl_topli sjgl_toplixl">
                <img src="__TMPL__statics/images/icon_person16x16.png" alt="" class="pic">
                <a href="<?php echo U('proxy/index/index');?>"><?php echo ($PROXY["proxy_name"]); ?> <?php echo ($PROXY_MEMBER["work_name"]); ?>，您好！</a>
            ...
            <li class="left sjgl_topli"><a href="<?php echo U('login/logout');?>"><em class="toptc"><img src="__TMPL__statics/images/sing_out.png" /></em></a></li>
        </ul>
    </div>
</div>
...
<div class="sjglBox">
    <div class="left sjgl_leftmenu">
        <ul style="margin-top:32px">
            ...
            <li class="leftMenu_li"><a class="leftMenu_a leftMenu_a2" target="main_frm" href="<?php echo U('shop/index');?>"><em>&nbsp;</em>商家管理</a></li>            <!-- <li class="leftMenu_li"><a class="leftMenu_a leftMenu_a2"  target="main_frm" href="<?php echo U('shop/index');?>"><em>&nbsp;</em>商家管理</a>
                <div class="leftNav2">
                    <ul>
                        <li><a target="main_frm" href="<?php echo U('goods/index');?>">商家列表</a></li>
                        <li><a target="main_frm" href="<?php echo U('goods/index');?>">创建商家</a></li>
                    </ul>
                </div>
            </li> -->
            
            <li class="leftMenu_li"><a class="leftMenu_a leftMenu_a3"  target="main_frm" href="<?php echo U('goods/index');?>"><em>&nbsp;</em>活动管理</a>
                <div class="leftNav2">
                    <ul>
            ...
            <li class="leftMenu_li"><a class="leftMenu_a leftMenu_a4" target="main_frm" href="<?php echo U('order/index');?>"><em>&nbsp;</em>订单管理</a>
                <div class="leftNav2">
                    <ul>
            ...
            <li class="leftMenu_li"><a class="leftMenu_a leftMenu_a5" target="main_frm" href="<?php echo U('money/index');?>"><em>&nbsp;</em>财务管理</a>
                <div class="leftNav2">
                    <ul>
                        <li><a target="main_frm" href="<?php echo U('money/balance');?>">结算明细</a></li>
                        <li><a target="main_frm" href="<?php echo U('money/szhi');?>">收支明细</a></li>
                    </ul>
                </div>
            </li>
           
            <li class="leftMenu_li"><a class="leftMenu_a leftMenu_a6" target="main_frm" href="<?php echo U('worker/index');?>"><em>&nbsp;</em>员工管理</a>
                <div class="leftNav2">
                    <ul>
                        <li><a target="main_frm" href="<?php echo U('worker/index');?>">员工列表</a></li>
                    </ul>
                </div>
            </li>
