...
<div class="tuan_content">
	<a class="radius3 sjgl_an tuan_topbt add" href="<?php echo U('worker/create');?>"><span>+</span>添加员工</a>
	...
	<?php if(is_array($list)): foreach($list as $key=>$var): ?><tr>
		<td><?php echo ($var["work_name"]); ?></td>
		<td><?php echo ($var["work_mobile"]); ?></td>
		<td><?php echo ($var["created_at"]); ?></td>
		<td>
			<!--<a class="tag tag3" href="<?php echo U('worker/edit',array('proxy_work_id'=>$var['proxy_work_id']));?>">角色设置</a>-->
			<a class="tag tag1" href="<?php echo U('worker/edit',array('proxy_work_id'=>$var['proxy_work_id']));?>">编辑</a>
			<!--<a class="tag tag2" href="<?php echo U('worker/delete',array('proxy_work_id'=>$var['proxy_work_id']));?>">删除</a>-->
            <span class="tag tag2" onclick="deleteworker(<?php echo ($var["proxy_work_id"]); ?>)">删除</span>
		</td>
